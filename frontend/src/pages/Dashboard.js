  ...
  useEffect(() => {
    ...
    const fetchResumes = async () => {
      try {
        ...
        const resumesData = Array.isArray(res.data)
          ? res.data
          : res.data.data || [];
      ...
      <main className="pt-24 pb-12 relative z-10">
        <div className="container mx-auto px-6">
          ...
          <div className="mb-16 animate-fade-in-down">
            <h1 className="section-title text-5xl md:text-6xl mb-4 text-glow">
              Welcome to Resume Analyzer
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl font-medium">
              Analyze your resume, improve your skills, and find perfect job
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Upload and analyze your resume with AI insights
              </p>
          ...
          <div className="glass card-hover p-8 animate-fade-in-up animation-delay-300">
            <div className="flex items-center mb-8">
              <svg
                className="w-6 h-6 mr-3 text-primary-600 animate-glow"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-start flex-1">
                          <svg
                            className="w-5 h-5 mt-1 mr-3 text-primary-400 flex-shrink-0 group-hover:animate-pulse"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span
                              className={`text-lg font-bold ${resume.analysis?.atsScore >= 75 ? "text-green-400" : resume.analysis?.atsScore >= 50 ? "text-yellow-400" : "text-red-400"}`}
                            >
                          ...
                          <div className="progress-bar">
                            <div
                              ...
                              style={{
                                width: `${resume.analysis?.atsScore || 0}%`,
                              }}
                            ></div>
                          </div>
                        </div>
